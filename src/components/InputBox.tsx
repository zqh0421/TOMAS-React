...
const InputBox = (props: { onSend: Function, isSending: boolean}, ref: Ref<unknown> | undefined) => {
  ...
  const handleRecord = () => {
    if (isSupportedBrowser()) {
      ...
      (window as unknown as MyWindow).transcriptionNotSupportedModal.showModal()
    }
  }
  ...
  return (
    <div>
      ...
      <form method="dialog" className="modal-box">
        ...
        <p className="py-4">Your browser is not supported for transcription. Please use Google Chrome or Microsoft Edge instead.</p>
